  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-base font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-5 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // FINSTICS custom variants
        calm: "bg-accent text-accent-foreground hover:bg-accent/90 shadow-sm hover:shadow-md",
        calmOutline: "border-2 border-accent text-accent hover:bg-accent hover:text-accent-foreground",
        subtle: "bg-secondary text-foreground hover:bg-muted",
        whatsapp: "bg-[hsl(142,70%,45%)] text-[hsl(0,0%,100%)] hover:bg-[hsl(142,70%,40%)] shadow-sm hover:shadow-md",
      },
      size: {
